  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="mt-6 bg-white p-4 rounded shadow-md">
        <h3 className="text-l font-bold mb-2">Match Between</h3>
        ...
        {/* Match Overs */}
        <h2 className="text-l font-bold mt-6">Overs</h2>
        <input
          type="number"
        ...
        <div className="flex space-x-4">
          {/* Toss Time */}
          <div className="mr-8">
            <h2 className="text-l font-bold mt-6 mb-2">Toss Win By</h2>
            <label className="pr-2"><input className="mr-4" 
                type="radio" 
                name="toss" 
                value={teams.teamA}
            ...
            <label className="pl-2"><input className="mr-4"  
                type="radio" 
                name="toss" 
                value={teams.teamB}
                checked={tossWin === teams.teamB}
                onChange={(e) => setTossWin(e.target.value)} />{teams.teamB}
            </label>
          </div>
          {/* Winning team Opt to */}
          <div className="ml-8">
            <h2 className="text-l font-bold mt-6 mb-2">and opt to</h2>
            <label className="pr-2"><input className="mr-4" 
                type="radio" 
                name="opt_to" 
                value="Bat First"
            ...
            <label className="pl-2"><input className="mr-4"  
                ...
                onChange={(e) => setOptTo(e.target.value)} />Bowled First
            </label>
          </div>      
        </div>      

        {/* Over Breakdown */}
        <h2 className="text-l font-bold mt-6">Over Breakdown</h2>
